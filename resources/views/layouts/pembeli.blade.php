...
<body>
    <div class="dashboard-wrapper">
        ...
        <aside class="sidebar" id="sidebar">
            <div class="sidebar-brand">EbookStore</div>

            <nav class="sidebar-nav">
                <a href="{{ route('pembeli.dashboard') }}" class="{{ request()->routeIs('pembeli.dashboard') ? 'active' : '' }}">
                    <i class="bi bi-grid"></i> Dashboard
                </a>
                {{-- Route 'pembeli.library' belum ada di web.php, lihat catatan setelah file ini --}}
                <a href="{{ route('pembeli.library') }}" class="{{ request()->routeIs('pembeli.library') ? 'active' : '' }}">
                    <i class="bi bi-journal-bookmark"></i> My Library
                </a>
                <a href="{{ route('pembeli.order.index') }}" class="{{ request()->routeIs('pembeli.order.index') ? 'active' : '' }}">
                    <i class="bi bi-clock-history"></i> Purchase History
                </a>
            </nav>

            <div class="sidebar-footer">
                <a href="{{ route('home') }}" class="btn-browse"><i class="bi bi-plus-lg"></i> Browse Books</a>
                <div class="user-mini">
